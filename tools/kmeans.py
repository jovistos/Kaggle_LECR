...
parser.add_argument('--v_dim', type=int, default=1024)   #768  1024
...
DF_PATH = "content_id_vector_v3_FlanEncoder_large_128.csv"
SAVE_PATH = f'semantic_embeding_v3_FlanEncoder_large_128.pkl'

df = pd.read_csv(DF_PATH)
df.rename(columns = {'target':'docid'}, inplace = True)
...
kmeans = KMeans(n_clusters=args.k, max_iter=1000, n_init=100, init='k-means++', random_state=args.seed, tol=1e-7)   #max_iter=300, n_init=100,

mini_kmeans = MiniBatchKMeans(n_clusters=args.k, max_iter=1000, n_init=100, init='k-means++', random_state=3,   #max_iter=300, n_init=100,
